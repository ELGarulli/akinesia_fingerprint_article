...
for fold_idx, (train_idx, test_idx) in enumerate(gkf.split(X_unique, groups=unique_groups)):
    if fold_idx>7:
        ...
        tmp_file = Path("/home/garullie/CEBRA_analysis/CEBRA_train/higher_offset/neural_folds_cm/models", f'run_splits_{fold_idx}_pd.pt')
        ...
        with open(f"./neural_predictions/predictions_neu_{fold_idx}_pd.pkl", 'wb') as handle:
