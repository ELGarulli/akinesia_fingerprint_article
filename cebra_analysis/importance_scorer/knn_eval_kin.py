...
with open(f"./embeddings/embeddings_folds_kin.pkl", "rb") as input_file:
...
with open(f"./embeddings/embeddings_test_folds_kin.pkl", "rb") as input_file:
    file = pkl.load(input_file)[index]
...
with open(f"./fold_eval/permutations_fold_{index}_kin.pkl", 'wb') as handle:
